...
values
('user1@gmail.com', 'Sanju', 'Samson', 'user123', '7687655432', '1', '2018-12-26 00:00:00', '1'
),
('user2@gmail.com', 'Riyan', 'Parag', 'user234', '9887676543', '0', '2019-02-22 00:00:00', '2'
),
('user3@gmail.com', 'Dhurav', 'Jurel', 'user345', '9878765432', '1', '2019-02-10 00:00:00', '3'
),
('user4@gmail.com', 'Jos', 'Buttler', 'user567', '9876324321', '1', '2019-06-22 00:00:00', '3'
),
('user5@gmail.com', 'Yuzi', 'Chahal', 'user789', '9876543221', '0', '2019-03-28 00:00:00', '1'
),
('user6@gmail.com', 'Ravi', 'Ashvin', 'user901', '8987673424', '1', '2020-12-30 00:00:00', '2'
);
...
values
('Sanju', 'N.', 'Samson', 'user1@gmail.com', 'Mumbai', 'CS', '2018-12-20', '7687655432', 
'415413', 'Mumbai', 'Good', 'Good', 'Good In Technical', 'Good', 'Accepted', 
'2018-12-26 00:00:00', '1'
),
('Riyan', 'P.', 'Parag', 'user2@gmail.com', 'Pune', 'Mechnaical', '2019-02-16', '9887676543', 
'435423', 'Pune', 'Avg', 'Strong', 'Good', 'Avg', 'Accepted', 
'2019-02-22 00:00:00', '2'
),
('Dhurav', 'K.', 'Jurel', 'user3@gmail.com', 'Bengalore', 'Civil', '2019-02-05', '9878765432', 
'456321', 'Bengalore', 'Neutral', 'Excellant', 'Avg', 'Good', 'Pending', 
'2019-02-10 00:00:00', '3'
),
('Jos', 'H.', 'Buttler', 'user4@gmail.com', 'Mumbai', 'E&TC', '2019-02-15', '9876324321', 
'432412', 'Mumbai', 'Good Behavioural', 'Medium', 'Good in Technical', 'Overall Good', 'Rejected',
 '2019-06-22 00:00:00', '3'
),
('Yuzi', 'N.', 'Chahal', 'user5@gmail.com', 'Pune', 'Electrical', '2019-03-20', '9876543221',
 '7865543232', 'Pune', 'Avg', 'Avg', 'Good Knowledge', 'Avg', 'Rejected', 
 '2019-03-28 00:00:00', '2'
),
('Ravi', 'V.', 'Ashvin', 'user6@gmail.com', 'Bengalore', 'M.Sc.', '2020-12-24', '8987673424',
 '412345', 'Bengalore', 'Strong', 'Good', 'Good Knowledge', 'Overall Good', 'Accepted', 
 '2020-12-30 00:00:00', '1'
);
...
(Id,Candidate_Id, First_Name, Middle_Name, Last_Name, EmailId, Hired_City, Degree, Hired_Date,
 ...
 values
 ('1','1', 'Sanju', 'N.', 'Samson', 'user1@gmail.com', 'Mumbai', 'CS', '2019-04-10', '7687655432', '415413', 'Mumbai', 'Good', 'Good', 'Good In Technical', 'Avg', '2019-02-22 00:00:00', '1994-02-20', '1', 'Nikesh', 'Farmer', '8987654321', '10000.00', 'New Colony, Kerala', 'Kerala', 'Path1', '2018-12-22', 'Accepted', 'Complete Education', 'Bank Of India', 'Complete B.Tech', 'Verified', 'All Up to date', '1'
),
('2','2', 'Riyan', 'P.', 'Parag', 'user2@gmail.com', 'Pune', 'Mechnaical', '2019-02-16', '9887676543', '435423', 'Pune', 'Avg', 'Strong', 'Good', 'Avg', '2019-02-22 00:00:00', '1998-05-20', '1', 'Paresh', 'Businessman', '8765322121', '90000.00', 'Happy Colony, Aasam', 'Aasam', 'Path2', '2019-02-10', 'Accepted', 'Pursing B.Tech', 'Baroda Bank', 'still not completed', 'Not verified', 'All good', '2'
),
('3','3', 'Dhurav', 'K.', 'Jurel', 'user3@gmail.com', 'Bengalore', 'Civil', '2019-02-05', '9878765432', '456321', 'Bengalore', 'Neutral', 'Excellant', 'Avg', 'Good', '2019-02-10 00:00:00', '1995-04-15', '0', 'KirtiKumar', 'Army', '9890786554', '86700.00', 'Prayagraj, UP', 'UP', 'Path3', '2019-08-15', 'Pending', 'Completed Edauction', 'PNB Bank', 'Just Completed Graduation', 'Verifeid', 'Good', '3'
),
('4','4', 'Jos', 'H.', 'Buttler', 'user4@gmail.com', 'Mumbai', 'E&TC', '2019-02-15', '9876324321', '432412', 'Mumbai', 'Good Behavioural', 'Medium', 'Good in Technical', 'Overall Good', '2019-06-22 00:00:00', '2000-09-20', '1', 'Harry', 'Working', '7876543221', '78000.00', 'Paris,UK', 'England', 'Path4', '2019-01-24', 'Rejected', 'Completed Graduation in Last Year', 'SBI Bank', 'Completed', 'Verified', 'All up to date', '3'
),
('5','5', 'Yuzi', 'N.', 'Chahal', 'user5@gmail.com', 'Pune', 'Electrical', '2019-03-20', '9876543221', '7865543232', 'Pune', 'Avg', 'Avg', 'Good Knowledge', 'Avg', '2019-03-28 00:00:00', '1999-05-20', '1', 'Naresh', 'Salesman', '9056433221', '67000.00', 'Bharintadta, Hariyana', 'Hariyana', 'Path5', '2019-02-22', 'Rejected', 'Complete Eduction', 'HDFC Bank', 'Eductaion Completed', 'Not verified', 'All Good', '2'
),
('6','6', 'Ravi', 'V.', 'Ashvin', 'user6@gmail.com', 'Bengalore', 'M.Sc.', '2019-05-24', '8987673424', '412345', 'Bengalore', 'Strong', 'Good', 'Good Knowledge', 'Overall Good', '2020-12-30 00:00:00', '1999-09-19', '1', 'Vikram', 'Cricketer', '8987673424', '90000.00', 'MarathaHalli, Bengalore', 'Bengalore', 'Path6', '2019-03-20', 'Accepted', 'Completed Education', 'RBI Bank', 'Complted', 'Verified', 'Good', '1'
);
...
('4', '4', 'Educational Document', 'Doc_Path4', 'Pending', '2019-06-22 00:00:00', '3'
),
('5', '5', 'Resume', 'Doc_Path5', 'Received', '2019-03-28 00:00:00', '2'
),
('6', '6', 'Cover Letter', 'Doc_Path6', 'Pending', '2020-12-30 00:00:00', '1'
);
...
values
('1', '1', 'Sanju', '1234567890', '1', 'ABCD22456', '1', 'ABCD1234F', '1', '1234-5678-9012-9032', '1', '2019-02-22 00:00:00', '1'
),
('2', '2', 'Riyan', '2345678901', '1', 'BCDE123456', '1', 'BDFG2333K', '1', '2345-6789-7654-6543', '1', '2019-02-22 00:00:00', '2'
),
('3', '3', 'Dhurav', '456789012', '0', 'FGHI2345J', '1', 'BDFG6767L', '1', '2344-3444-5667-8997', '1', '2019-02-10 00:00:00', '3'
),
('4', '4', 'Jos', '4567890123', '1', 'BFGC1234K', '0', 'DCVG1567M', '0', '1233-4566-7890-6677', '0', '2019-06-22 00:00:00', '3'
),
('5', '5', 'Yuzi', '34567890123', '1', 'ADCF123456', '1', 'SDCF5677K', '1', '6677-9080-6778-8990', '1', '2019-03-28 00:00:00', '3'
),
('6', '6', 'Ravi', '567890123', '1', '233456778990', '1', 'BGHI2344J', '1', '7899-9012-3344-55467', '1', '2020-12-30 00:00:00', '1'
);
...
('4', '4', 'Diploma in E&TC', 'E&TC', '1', 'Software UI Designer', '1', '2018', '1', '67.00', '1', '75.00', '1', 'SquareIT', '1', '7', '1', 'Java + Spring Boot', '1', '2019-06-22 00:00:00', '1'
),
('5', '5', 'Diploma in Electrical', 'Electrical', '1', 'Electrical Design Enginner', '1', '2017', '1', '63.00', '1', '72.00', '1', 'ArayanIT', '1', '6', '1', 'HTML+CSS+JS', '1', '2019-03-28 00:00:00', '3'
),
('6', '6', 'B.Sc.', 'M.Sc.', '1', 'Software Developer', '1', '2019', '1', '78.00', '1', '84.00', '1', 'NaviInfoTech', '1', '5', '1', 'React Js', '1', '2020-12-30 00:00:00', '2'
);
...
('4', 'Husk Power', 'Kharadi', 'Pune', 'Active', '2019-05-22 00:00:00', '3'
),
('5', 'FUEL', 'PCMC', 'Pimpri', 'Inactive', '2019-02-28 00:00:00', '1'
),
('6', 'Bajaj', 'MarathaHalli', 'Bengalore', 'Active', '2020-11-30 00:00:00', '2'
);
...
('4', 'CUR_STATUS', 'IACTV', 'Inactive', 'ACTV', '4', '2019-06-22 00:00:00', '2019-06-22 00:00:00', '4', '1'
),
('5', 'BATCH_STATUS', 'INPROCESS', 'In Process', 'ACTV', '5', '2019-03-28 00:00:00', '2019-03-28 00:00:00', '5', '1'
),
('6', 'BATCH_STATUS', 'HOLD', 'Hold', 'ACTV', '6', '2020-12-30 00:00:00', '2020-12-30 00:00:00', '6', '2'
);

insert into Lab
(Id, Name, Location, Address, Status, Creator_Stamp, Creator_User)
values
('1', 'Mumbai', 'Addess1,Mumbai', 'Govandi,Mumbai', 'Active', '2010-02-22 00:00:00', '1'
),
...
values
('1', '1', '1', 'ACTIVE', '2024-05-05 11:14:12', '1'
),
('2', '1', '2', 'ACTIVE', '2024-05-05 11:14:12', '2'
),
('3', '2', '1', 'ACTIVE', '2024-05-05 11:14:12', '3'
),
('4', '3', '3', 'ACTIVE', '2024-05-05 11:14:12', '3'
),
('5', '4', '4', 'ACTIVE', '2024-05-05 11:14:12', '2'
),
('6', '5', '1', 'ACTIVE', '2024-05-05 11:14:12', '1'
),
('7', '5', '5', 'ACTIVE', '2024-05-05 11:14:12', '2'
),
('8', '6', '2', 'ACTIVE', '2024-05-05 11:14:12', '3'
),
('9', '7', '3', 'ACTIVE', '2024-05-05 11:14:12', '1'
);
...
Status, Creator_Stamp, Creator_User)
values
('1', '1', '50', '10', '8', '6', 'Active', '2024-05-05 11:14:12', '1'
),
('2', '2', '60', '12', '9', '7', 'Active', '2024-05-05 11:14:12', '2'
),
('3', '3', '70', '15', '10', '8', 'Active', '2024-05-05 11:14:12', '3'
),
('4', '3', '55', '11', '8', '6', 'Active', '2024-05-05 11:14:12', '3'
),
('5', '2', '45', '9', '7', '5', 'Active', '2024-05-05 11:14:12', '2'
),
('6', '1', '65', '13', '10', '7', 'Active', '2024-05-05 11:14:12', '1'
);
...
(Id, Company_Id, Requested_Month, City, Is_Doc_Verification, Requirement_Doc_Path, No_of_Engg,
 ...
 values
 ('1', '1', '2024-03-01', 'Mumbai', '1', 'requirement_doc_1.pdf', '10', '1', '1', '1', '1', '1', '3', 'Good in java', 'Active', '2024-05-05 11:14:12', '1'
),
 ('2', '2', '2023-08-01', 'Banglore', '0', 'requirement_doc_2.pdf', '4', '1', '1', '2', '5', '2', '2', 'Good in java', 'Active', '2024-05-05 11:14:12', '2'
),
('3', '3', '2024-01-01', 'Pune', '1', 'requirement_doc_3.pdf', '6', '3', '3', '3', '6', '3', '4', 'Good in php', 'Active', '2024-05-05 11:14:12', '3'
),
('4', '4', '2022-01-01', 'Mumbai', '1', 'requirement_doc_4.pdf', '3', '4', '3', '4', '1', '4', '4', 'good in python', 'Active', '2024-05-05 11:14:12', '3'
),
('5', '5', '2024-03-01', 'Pune', '1', 'requirement_doc_5.pdf', '7', '5', '3', '5', '5', '5', '4', 'Good in angular', 'Active', '2024-05-05 11:14:12', '2'
),
('6', '6', '2024-03-01', 'Banglore', '1', 'requirement_doc_6.pdf', '4', '1', '3', '6', '1', '1', '4', 'Good in java', 'Active', '2024-05-05 11:14:12', '1'
);
